...
//        wifi.setOnClickListener(view -> connect_ap(ssid)) ;
    ...
    private static String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        if (id.indexOf("ID") != -1) {
            StringBuffer findid = id.replace(0, id.indexOf("ID") + 2, "");
            String WID = findid.substring(id.indexOf("ID") + 2, id.indexOf("\n"));
            StringBuffer findpw = id.replace(0, id.indexOf("PW") + 2, "");
            String WPW = findpw.substring(id.indexOf("PW") + 2, id.indexOf("\n"));
